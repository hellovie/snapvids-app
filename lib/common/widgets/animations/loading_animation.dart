...
const double _circleSize = 15;
const double _boxWidth = _circleSize * (52 / 25);
const double _boxHeight = _circleSize * (30 / 25);
...
class _LoadingAnimationState extends State<LoadingAnimation> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _animationTranslateForward = Tween(begin: 0.0, end: _circleSize).animate(
      CurvedAnimation(
    ...
    _animationTranslateBackward = Tween(begin: _circleSize, end: 0.0).animate(
      CurvedAnimation(
        parent: _animationController,
        curve: Curves.easeInOut,
      ),
